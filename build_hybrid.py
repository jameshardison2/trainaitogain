...
new_hero = """
  ...
  <header style="padding: 64px 0 40px; text-align: center; background-color: var(--white);">
    <div class="container" style="max-width: 800px;">
      ...
      <!-- Social Proof Row -->
      <div style="display:flex; flex-wrap:wrap; align-items:center; justify-content:center; gap:24px; margin-bottom:40px;">
        <!-- Fake Stripe Payout Notification -->
        <div style="background:var(--white); border:1px solid #E5E7EB; border-radius:12px; padding:16px; display:inline-flex; align-items:center; gap:16px; box-shadow:0 10px 25px -5px rgba(0,0,0,0.05); text-align:left;">
        ...
        <!-- High-Status Testimonial Quote -->
        <div style="background:var(--white); border:1px solid #E5E7EB; border-radius:12px; padding:16px; display:inline-flex; align-items:center; gap:16px; box-shadow:0 10px 25px -5px rgba(0,0,0,0.05); text-align:left; max-width: 320px;">
          <div style="width:40px; height:40px; border-radius:50%; overflow:hidden; flex-shrink:0;">
            <img src="https://i.pravatar.cc/150?img=32" alt="Dr. Sarah K." style="width:100%; height:100%; object-fit:cover;" />
          </div>
          <div>
            <p style="margin:0 0 4px 0; font-size:12px; font-style:italic; color:#4B5563; line-height:1.4;">"Incredible remote opportunity. I consult for 5 hours a week and earn an extra $3k/mo."</p>
            <p style="margin:0; font-size:11px; font-weight:700; color:#111827;">Dr. Sarah K. &mdash; Medical Expert</p>
          </div>
        </div>
      </div>
